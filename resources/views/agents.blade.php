...
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    ...
    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
        <button class="button text-white bg-theme-42 shadow-md mr-2"><a href="{{route('show_add_agent')}}">Add
                Agent</a></button>
    </div>
    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            ...
            <tr>
                ...
                <td>
                    <a class="flex items-center text-theme-1 mr-1"
                        href="{{route('edit_agent' , ['id' =>  $value->id])}}"><i data-feather="edit"
    ...
    <div class="modal" id="delete-modal-preview">
        <div class="modal__content">
            ...
            <div class="px-5 pb-8 text-center">
                <form type="submit" action="{{route('delete_agent')}}" method="post">
                    @csrf
                    @method('DELETE')
                    <input type="hidden" name="delete_agent_id" id="deleting_id"></input>
