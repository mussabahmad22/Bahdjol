        ...
        <table id="myTable" class="table table-report table-report--bordered display w-full ">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button style="border:none;" type="button" value="{{$help->id}}"
                            class="deletebtn btn"><a class=" flex items-center text-theme-6" href="javascript:;" data-toggle="modal" data-target="#delete-modal-preview"> <i data-feather="trash-2"
    ...
    <div class="modal" id="delete-modal-preview">
        <div class="modal__content">
            ...
            <div class="px-5 pb-8 text-center">
                <form type="submit" action="{{route('delete_help')}}" method="post">
                    @csrf
                    @method('DELETE')
                    <input type="hidden" name="delete_help_id" id="deleting_id"></input>
